...
[![FlakeHub](https://img.shields.io/endpoint?url=https://flakehub.com/f/outskirtslabs/datomic-pro/badge)](https://flakehub.com/flake/outskirtslabs/datomic-pro)
...
```nix
{
  inputs.
   inputs = {
        ...
        datomic-pro.url = "https://flakehub.com/f/Ramblurr/datomic-pro/0.8.0.tar.gz";
...
``` nix
{
    services.datomic-pro = {
        enable = true;
        package = pkgs.datomic-pro_1_0_7469;
...
``` shell
docker/podman pull ghcr.io/outskirtslabs/datomic-pro:1.0.7469
```
...
services:
  datomic-transactor:
    image: ghcr.io/outskirtslabs/datomic-pro:1.0.7469
    environment:
