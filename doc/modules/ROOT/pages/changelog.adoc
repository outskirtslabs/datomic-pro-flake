...
https://docs.datomic.com/changes/pro.html#1.0.7491[version 1.0.7491]
...
* Switch from https://semver.org/spec/v2.0.0.html[SemVer] to
https://www.taoensso.com/break-versioning[BreakVer]. I actually had
...
* Added package versions for
https://docs.datomic.com/changes/pro.html#1.0.7482[version 1.0.7482]
...
* Added package versions for
https://docs.datomic.com/changes/pro.html#1.0.7469[version 1.0.7469]
...
* Added package versions for
https://docs.datomic.com/changes/pro.html#1.0.7394[version 1.0.7394]
...
* Added package versions for
https://docs.datomic.com/changes/pro.html#1.0.7387[version 1.0.7387]
...
https://docs.datomic.com/changes/pro.html#1.0.7364[version 1.0.7364].
...
https://flakehub.com/flake/ramblurr/datomic-pro?view=releases[flakehub's]
release process.
